 ...
 * 
 *  Project: Nether
 *  File: SubstanceThemesEnum.java
 *  Date: 2/01/2018 10:00:00
 *  Author: Héctor Martínez <hector.mtz.grc@gmail.com>
 */
package nether.util.laf.themes.test;

/**
 * This class contains an enum of the substance look and feel themes used in the
 * application.
 *
 * @author Héctor
 */
public enum SubstanceThemesEnum {
    ...
    /**
     * Class constructor required to have enum items with String values.
     * This constructor is mandatory in order to have the mentioned values
     * above.
     *
     * @param enumValue Enum item string value.
     */
    private SubstanceThemesEnum(String enumStringValue) {
        this.themeString = enumStringValue;
    }
    ...
    public static String[] toArray() {
        ...
        themesArray = new String[SubstanceThemesEnum.values().length];

        for (SubstanceThemesEnum value : SubstanceThemesEnum.values()) {
